...
export default {
  ...
  methods: {
        ...
        navigator.geolocation.getCurrentPosition(
          (position) => {
            ...
            this.map.addListener('click', (event) => {
              ...
              if (this.userProfile) {
                axios.post('https://5b4c-114-45-71-5.ngrok-free.app/checkin', {
                  latitude: pos.lat,
                  longitude: pos.lng,
                  timestamp: timestamp,
    ...
    fetchMarkers() {
      axios.post('https://5b4c-114-45-71-5.ngrok-free.app/fetch_checkins')
        .then(response => {
    ...
    resetMap() {
      axios.delete('https://5b4c-114-45-71-5.ngrok-free.app/checkins')
        .then(() => {
